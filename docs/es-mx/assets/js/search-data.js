    ...
    handler: () => {
      window.location.href = "/es-mx/";
        ...
        handler: () => {
          ...
          description: "",
          section: "",handler: () => {
              window.location.href = "/es-mx/books/en-us/defying_displacement/";
            },},{id: "books-how-to-kill-a-city",
          title: 'How to Kill a City',
          description: "",
          section: "",handler: () => {
              window.location.href = "/es-mx/books/en-us/how_to_kill_a_city/";
            },},{id: "books-país-sin-techo",
          title: 'País sin Techo',
          description: "",
          section: "",handler: () => {
              window.location.href = "/es-mx/books/en-us/pais_sin_techo/";
          ...
          description: "",
          section: "",handler: () => {
              window.location.href = "/es-mx/news/en-us/announcement_1/";
          ...
          section: "",handler: () => {
              window.location.href = "/es-mx/projects/en-us/2017-11-3-video/";
          ...
          section: "",handler: () => {
              window.location.href = "/es-mx/projects/en-us/2017-12-09-botemmett/";
          ...
          section: "",handler: () => {
              window.location.href = "/es-mx/projects/en-us/2017-12-11-coalitions/";
          ...
          section: "",handler: () => {
              window.location.href = "/es-mx/projects/en-us/2018-10-10-fractals/";
          ...
          section: "",handler: () => {
              window.location.href = "/es-mx/projects/en-us/2018-10-25-CA/";
          ...
          section: "",handler: () => {
              window.location.href = "/es-mx/projects/en-us/2019-08-18-Asylum/";
          ...
          section: "",handler: () => {
              window.location.href = "/es-mx/projects/en-us/2019-10-06-Earthquake/";
          ...
          section: "",handler: () => {
              window.location.href = "/es-mx/projects/en-us/2020-02-07-ebola/";
          ...
          section: "",handler: () => {
              window.location.href = "/es-mx/projects/es-mx/2020-03-13-SIS/";
          ...
          section: "",handler: () => {
              window.location.href = "/es-mx/projects/en-us/2025-01-08-disparities/";
          ...
          section: "",handler: () => {
              window.location.href = "/es-mx/projects/en-us/2025-08-15-workreach/";
            },},{
        id: 'social-bluesky',
        title: 'Bluesky',
        section: '',
